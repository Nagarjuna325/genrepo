...
----------------------------
- Multithreaded record generating (gensort) and order validation (valsort).
- Direct mode reads and writes are the default. To use standard (buffered)
  reads and writes, append ",buf" to the file name on the gensort or valsort
  command line.
